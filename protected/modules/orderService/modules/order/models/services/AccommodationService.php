 ...
 * Реализует функциональность работы с атрибутами услуги типа AccommodationService
 */
class AccommodationService extends Service implements IService
{
    /**
