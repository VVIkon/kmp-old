<div class="service-form-tos-agreement js-service-form-tos-agreement {{#agreementDisabled}}disabled{{/agreementDisabled}}">
  ...
  <span class="service-form-tos-agreement__text">
    С 
    <span class="service-form-tos-agreement__tos-link js-service-form-tos-agreement--tos-link" data-link="companyTOS">условиями компании</span>, 
    <span class="service-form-tos-agreement__tos-link js-service-form-tos-agreement--tos-link" data-link="aviaFareRule-{{serviceId}}">условиями тарифа</span>, 
    <span class="service-form-tos-agreement__tos-link js-service-form-tos-agreement--tos-link" data-link="aviaBookTerms">условиями бронирования перелетов</span> 
